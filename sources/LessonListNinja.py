...
class MagicLessonListNinja(Toplevel):
    def __init__(self,parent,*args, **kwargs):
        ...
        s.configure('Blue.TButton', background="deepskyblue4", foreground="snow")
